...
namespace testXS
{
	partial class TestL2ViewController : ReactiveViewController,IViewFor<FilterViewModel<LocationViewModel, int>>
	{
		public TestL2ViewController (IntPtr handle) : base (handle)
		{
		}
